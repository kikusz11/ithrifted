  ...
  return (
    <div className="bg-stone-50 text-stone-900 min-h-screen">
      <section className="relative text-center py-20 md:py-32 px-4 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-stone-200 via-stone-300 to-stone-400 opacity-90"></div>
      ...
      <section className="bg-stone-100 py-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-3 text-stone-900">Ne maradj le semmiről!</h2>
          ...
          <form onSubmit={handleSubscription} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
            <input
              ...
              className="flex-grow bg-stone-200 border border-stone-300 rounded-lg px-4 py-3 text-stone-900 placeholder-stone-500 focus:outline-none focus:ring-2 focus:ring-stone-500 transition duration-300"
            />
            <button
              type="submit"
              disabled={formLoading}
              className="bg-stone-800 hover:bg-stone-900 text-white font-semibold py-3 px-6 rounded-lg transition duration-300 disabled:bg-gray-500"
            >
