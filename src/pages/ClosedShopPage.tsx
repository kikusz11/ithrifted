...
export default function ClosedShopPage() {
    ...
    return (
        <div className="font-sans selection:bg-stone-300 selection:text-stone-900 bg-stone-50 text-stone-900 transition-colors duration-300">
            <SEO
            ...
            <section className="relative min-h-[90vh] flex flex-col items-center justify-center text-center px-4 overflow-hidden pt-20">
                ...
                <div className="absolute top-0 left-0 w-full h-full bg-stone-100 z-0 text-stone-900 overflow-hidden">
            ...
            <section className="py-24 bg-stone-50 overflow-hidden transition-colors duration-300">
            ...
            <section id="location" className="py-24 bg-stone-50 relative border-t border-stone-200 overflow-hidden transition-colors duration-300">
            ...
            <section id="online-drop" className="relative py-24 px-4 bg-stone-50 border-t border-stone-200 text-center overflow-hidden transition-colors duration-300">
