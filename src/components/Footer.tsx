                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="space-y-2 text-sm text-gray-400">
                            ...
                            <div className="pt-2 space-y-1">
                                <a href="mailto:info@ithrifted.hu" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
                                    <Mail size={16} />
                                    <span>info@ithrifted.hu</span>
                                </a>
                                <a href="tel:+36301234567" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
                                    <Phone size={16} />
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            <li>
                                <Link to="/aszf" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
                                    <FileText size={16} />
                                    <span>Általános Szerződési Feltételek (ÁSZF)</span>
                                </Link>
                            </li>
                            <li>
                                <Link to="/adatkezeles" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
                                    <Shield size={16} />
                    ...
                    <div className="space-y-4">
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            <li>
                                <Link to="/elallasi-jog" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
                                    <AlertCircle size={16} />
                                    <span>Elállási jog (14 nap)</span>
                                </Link>
                            </li>
                            <li>
                                <a href="https://bekeltetes.hu/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-blue-400 transition-colors">
                                    <Shield size={16} />
