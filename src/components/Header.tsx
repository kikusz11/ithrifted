...
// JAVÍTVA: Import útvonalak a projekt struktúrájához igazítva
...
  
  // --- VÁLTOZTATÁS KEZDETE ---
  const { user, profile, loading } = useAuth(); // 'profile' hozzáadva a hook-hoz
  // --- VÁLTOZTATÁS VÉGE ---
...
          <Link to="/" className="flex items-center gap-2">
  <img 
    src={logo} 
    alt="iThrifted Logo" 
    className="h-16 w-auto" // A magasságot (pl. h-8) állítsd be ízlés szerint
  />
